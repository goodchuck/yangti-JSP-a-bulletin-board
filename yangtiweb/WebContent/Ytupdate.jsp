...
<%
	...
	if(userID == null) {
		...
		script.println("location.href = 'Ytlogin.jsp'");
		script.println("</script>");
	}
	int bbsID = 0;
...
%>
	...
	<div class="container">
	<div class="row">
	<form method="post" action="YtupdateAction.jsp?bbsID=<%= bbsID %>">
		...
		<!-- 게시판 글 목록들이 홀수 짝수 색깔다르게하는거 -->
			...
			<tr>
			<td>
			<textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2048" style="height:350px;"><%=bbs.getBbsContent() %></textarea></td>
				<!-- 장문의 글을 작성할때 사용 -->
			</tr>
